...
# EDIT THIS FILE FOR:
# - the base Risk Sizing Part 1 / Part 2 widget sequence, two-pane alignment, section headers, result grouping, and table presentation.
    ...
    *,
    ...
    with book_col:
        ...
        st.markdown(
            ...
            '% TACTICAL SLEEVE = TARGET-SLEEVE USAGE'
            '</div>',
            unsafe_allow_html=True,
        )
        st.dataframe(
